...
class opt_parse {
 public:
  typedef struct AllocatableResource {
  ...
  cxxopts::ParseResult parse(int argc, char **argv) {
    try {
      ...
      options.positional_help("task_name [Task Args...]")
  ...
  AllocatableResource GetAllocatableResource(
    ...
    allocatableResource.memory_limit_bytes = uint;

    uint = memory_parse_client("nmemory_swap", result);
    allocatableResource.memory_sw_limit_bytes = uint;
